...
<body>
        ...
        <%
            try {
             ...
             //   System.out.println("Connection Success..!!");
                ...
                ResultSet rs = st.executeQuery("select * from feestable");
                ...
                while (rs.next()) {
                    ...
                    out.println("<td>" + rs.getDouble("completedFees") + "</td>");
                    out.println("<td>" + rs.getDouble("pendingFees") + "</td>");
    ...
    <form action="UpdateFeesStatus.jsp" method="post">
        <input type="text" placeholder="Enter PRN" name="PRN">
        <input type="number" placeholder="Amount " name="Fees" >
        <input type="submit" value="Update Fees" id="markFeesPaid">
	</form>
	
	
	
	<form action="AddNewStudentInFess.html" method="post">
        <input type="submit" value="Add New Details" id="markFeesPaid">
	</form>
