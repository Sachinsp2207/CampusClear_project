...
<body>
            ...
            try {
             ...
             //   System.out.println("Connection Success..!!");
                ...
                while (rs.next()) {
                    ...
                    out.println("<td>" + rs.getString("req") + "</td>");
                    out.println("</tr>");
                }
    ...
    <form action="MarkStudentAsCleared.jsp" method="post">
        <input type="text" placeholder="Enter PRN" name="PRN">
        <input type="submit" value="Mark Student As Record Cleared" id="markFeesPaid">
	</form>
       
        <form action="ForwardRequest.jsp" method="post">
        <input type="text" placeholder="Enter PRN" name="PRN">
        <input type="submit" value="Forward Request to Dashboards" name="forwardRequest">
    </form>
