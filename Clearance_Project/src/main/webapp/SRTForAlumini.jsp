...
<body>
    <h1>Student Table For Alumini </h1>
    <table>
        <tr>
            <th>Name</th>
            <th>Email</th>
    	...
    	<form action="UpdateAluminiStatusINStudentTable.jsp" method="post">
        <input type="text" placeholder="Enter PRN" name="PRN">
          <input type="text" placeholder="400 paid/Pending" name="AlFees">
        <input type="submit" value=" Update Alumini Fess" id="AluminiFees">  
    	</form>
