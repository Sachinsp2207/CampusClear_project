...
<body>
    <h1>Student Details For Principal </h1>
    <table>
        <tr>
            <th>Name</th>
            <th>Contact</th>
        ...
        <form action="PrincipalRemark.jsp" method="post">
        <input type="text" placeholder="Enter PRN" name="PRN">
          <input type="text" placeholder="Allowed/Not Allowed" name="Principal">
        <input type="submit" value="Principal Aproval" id="AluminiFees">  
    	</form>
    	
    	 <form action="PrincipalDashBoard.html">
