...
<body>
    ...
    <p> Note:You Only Allowed To Mark Your Own Field Only.</p>
    	...
    	<form action="UpdateExam.jsp" method="post">
        <input type="text" placeholder="Enter PRN" name="PRN">
          <input type="text" placeholder="Completed /Incompleted" name="Fees">
        <input type="submit" value="Update Fees As Accountant" id="markFeesPaid">  
    	</form>
    	
    	<form action="UpdateExam.jsp" method="post">
        <input type="text" placeholder="Enter PRN" name="PRN">
          <input type="text" placeholder="Yes / No" name="Book">
        <input type="submit" value="Updae Book Peding or Not" id="markBook">  
    	</form>
    	
    	<form action="UpdateExam.jsp" method="post">
        <input type="text" placeholder="Enter PRN" name="PRN">
          
        <input type="submit" value=" Proceed Alumini Fess" id="AluminiFees">  
    	</form>
    	
    	<form action="UpdateExam.jsp" method="post">
        <input type="text" placeholder="Enter PRN" name="PRN">
          
        <input type="submit" value="Proceed Library Deposit" id="AluminiFees">  
    	</form>
    	
    	<form action="UpdateExam.jsp" method="post">
        <input type="text" placeholder="Enter PRN" name="PRN">
          <input type="text" placeholder="Allowed/Not Allowed" name="Exam">
        ...
        <input type="text" placeholder="Enter PRN" name="PRN">
          <input type="text" placeholder="Allowed/Not Allowed" name="Exam">
        <input type="submit" value="Principal Aproval" id="AluminiFees">  
    	</form>
