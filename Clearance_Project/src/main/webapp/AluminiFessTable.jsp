...
<html>
<head>
    <title>Alumini Fees Table</title>
    <style>
        body {
...
<body>
    <h1>Alumini Fees Table</h1>
    <table>
        <tr>
        	 <th>PRN</th>
            <th>Name</th>
            <th>Alumini Fees Status</th>
        ...
        <%
            try {
             ...
             //   System.out.println("Connection Success..!!");
                ...
                ResultSet rs = st.executeQuery("select * from aluminifees");
                ...
                while (rs.next()) {
                    ...
                    out.println("<td>" + rs.getString("AluminiFeesStatus") + "</td>");
                    out.println("<td>" + rs.getString("Transactionid") + "</td>");       
                    out.println("</tr>");
                }
    ...
    <form action="UpdateAluminiFees.jsp" method="post">
        <input type="text" placeholder="Enter PRN" name="PRN">
        <input type="text" placeholder="Paid/Unpaid" name="AlStatus">
        <input type="text" placeholder="Transaction Id" name="Tid" >
        <input type="submit" value="Update Fees" id="markFeesPaid">
	</form>
       

   		
        <form action="AluminiDashBoard.html">
    ...
    document.getElementById("markFeesPaid").addEventListener("click", function () {
        ...
        window.location.href = "MarkStudentAsCleared.jsp";
    });
