...
<body>
            ...
            try {
             ...
             //   System.out.println("Connection Success..!!");
                ...
                while (rs.next()) {
                    ...
                    out.println("<td>" + rs.getString("book_issued") + "</td>");
    ...
    <form action="UpdateBookStatus.jsp" method="post">
        <input type="text" placeholder="Enter PRN" name="PRN">
        <input type="text" placeholder="Collected/Pending" name="Status" >
        <input type="submit" value="Update Book Status" id="markFeesPaid">
	</form>
       
        <form action="IssueBook.jsp" method="post">
        <input type="text" placeholder="Enter PRN" name="PRN">
        <input type="text" placeholder="Book Name" name="Issue" >
        <input type="submit" value="Issue A Book " name="forwardRequest">
    </form>
    
    <form action="CreateNewAccountInLib.html" method="post">
        <input type="submit" value="Create New Account" name="CNA">
    </form>
   		<br><br>
        <form action="LibraryDashBoard.html">
