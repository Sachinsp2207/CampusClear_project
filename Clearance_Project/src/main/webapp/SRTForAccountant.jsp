...
<body>
    <h1>Student Details For Accountant</h1>
    <table>
        <tr>
            <th>Name</th>
            <th>Email</th>
    	...
    	<form action="UpdateFees.jsp" method="post">
        <input type="text" placeholder="Enter PRN" name="PRN">
          <input type="text" placeholder="Completed /Incompleted" name="msg">
        <input type="submit" value="Update Fees Status" id="markFeesPaid">  
    	</form>
    	<p>Note : Here Your Library Deposit Is Converted Into Your Alumini Fess </p>
    	<form action="UpdateAluminiFeesAsLibraryDeposit.jsp" method="post">
        <input type="text" placeholder="Enter PRN" name="prn">
          <input type="text" placeholder="Collected/Pending" name="Deposit">
           <input type="text" placeholder="Paid/Unpaid" name="AlFTable">
        <input type="submit" value="Convert Library Diposit into Alumini Fees" id="markFeesPaid">  
    	</form>
    	
  <form action="AccountantDashBoard.html">
